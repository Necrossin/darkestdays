...
function EFFECT:Init(data)
	...
	if self.WeaponEnt:IsCarriedByLocalPlayer() and GetViewEntity() == MySelf and !GAMEMODE.ThirdPerson then 
		...
		self.EjectionPort = self.WeaponEnt:GetAttachment(1)//self.Attachment
		if not self.EjectionPort then return end
