...
function ENT:Move( mv )
	...
	if not owner:OnGround() and owner:KeyDown( IN_SPEED ) and not IsValid(owner._efSlide) and owner:IsSprinting() and owner._DefaultRunSpeedBonus and owner._DefaultRunSpeedBonus > 0 and !owner:HasWeapon( "dd_striker" ) and not owner:IsThug() then
