...
if CLIENT then
	...
	GAMEMODE:KilliconAddFont("dd_m4_silenced", "CSKillIcons", SWEP.IconLetter, Color(255, 255, 255, 255 ))
...
function SWEP:InitializeClientsideModels()
	...
	self.VElements = {
		...
		//["cast_point"] = { type = "Model", model = "models/props_junk/PopCan01a.mdl", bone = "v_weapon.Right_Hand", rel = "", pos = Vector(0.864, -0.072, -0.68), angle = Angle(-75, 0, 0), size = Vector(0.224, 0.224, 0.224), color = Color(255, 255, 255, 0), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
