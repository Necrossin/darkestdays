...
Weapons = {
	...
	["dd_fists"] = {
		...
		Melee = true,
		Mat = Material( "darkestdays/icons/fists_256x128.png", "smooth" ),
...
Perks = {
	["hpregen"] = {
		...
		Mat = Material( "darkestdays/hud/hpregen.png" ),
	...
	["thug"] = {
		Name = "perk_thug_name",
		Mat = Material( "darkestdays/hud/thug.png" ),
		AdminFree = true,
	...
	["adrenaline"] = {
		...
		Mat = Material( "darkestdays/hud/adrenaline.png" ),
	...
	["martialarts"] = {
		...
		Mat = Material( "darkestdays/hud/martialarts.png" ),
	...
	["dash"] = {
		Name = "perk_dash_name",
		Mana = 25,
		Mat = Material( "darkestdays/hud/dash.png" ),
	...
	["transcendence"] = {
		...
		Mat = Material( "darkestdays/hud/transcendence.png" ),
