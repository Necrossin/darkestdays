...
Perks = {
	...
	["dash"] = {Name = "Dash", Special = "Press sprint to dash in any direction\nMANA SICKNESS: Requires at least 20\nactive mana to work\n", Pr = "Two-Handed weapons: press attack\nwhile dashing forward, to perform\na dash attack", Co = "Costs 25% of your mana per dash\nCosts even more mana per dash attack\n-15 max health",OnSet = function(pl) pl._DefaultHealth = pl._DefaultHealth - 15; if SERVER then pl:SendLua("LocalPlayer()._ShiftUses = 4 LocalPlayer()._ShiftCap = 20") end end, OnReset = function(pl) if SERVER then pl:SendLua("LocalPlayer()._ShiftUses = nil LocalPlayer()._ShiftCap = nil") end end},
