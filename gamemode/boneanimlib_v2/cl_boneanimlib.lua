...
function meta:ResetLuaAnimation(sAnimation, fDieTime, fPower, fTimeScale)
	...
	if animtable then
		...
		Type = animtable.Type, RestartFrame = animtable.RestartFrame, TimeToArrive = animtable.TimeToArrive, Callback = animtable.Callback, ShouldPlay = animtable.ShouldPlay, OverrideTimeToArrive = animtable.OverrideTimeToArrive,
